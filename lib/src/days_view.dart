...
class _DayPickerGridDelegate extends SliverGridDelegate {
  ...
  SliverGridLayout getLayout(SliverConstraints constraints) {
    ...
    final tileHeight = math.min(_kDayPickerRowHeight, constraints.viewportMainAxisExtent / (_kMaxDayPickerRowCount + 1));
...
class _DaysView extends StatelessWidget {
  ...
  List<Widget> _getDayHeaders(Language language, TextStyle? headerStyle, HeaderDayType headerDayType, HeaderDayBuilder? builder) {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        final disabled = dayToBuild.isAfter(lastDate) || dayToBuild.isBefore(firstDate) || (selectableDayPredicate != null && !selectableDayPredicate!(dayToBuild));
...
final List<String> dayHeaderFullNameEnglish = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
final List<String> dayHeaderFullNameNepali = ["आइतबार", "सोमबार", "मन्गलबार", "बुधबार", "बिहीबार", "शुक्रबार", "शनीबार"];
final List<String> dayHeaderHalfNameEnglish = ["Sun", "Mon", "Tues", "Wed", "Thu", "Fri", "Sat"];
final List<String> dayHeaderHalfNameNepali = ["आइत", "सोम", "मन्गल", "बुध", "बिही", "शुक्र", "शनी"];
